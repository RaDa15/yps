...
function DashboardHero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-r from-blue-700 via-blue-600 to-indigo-600 rounded-3xl
      p-8 lg:p-10 text-white shadow-xl">

      {/* Background Decoration */}
      <div
        className=" absolute right-0 top-0 w-72 h-72 bg-white opacity-10 rounded-full translate-x-20 -translate-y-20">
      </div>

      <div className=" absolute left-0 bottom-0 w-40 h-40 bg-white opacity-10 rounded-full -translate-x-10 translate-y-10"></div>
      
      <div className=" relative z-10 grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">

        {/* Welcome */}
        <div className="lg:col-span-2">
          <p className="text-blue-100font-medium">
            Good Morning 👋
          </p>
          ...
          {/* XP Progress */}
          <div className=" mt-8 bg-white/20 backdrop-blur-md rounded-2xl p-5 max-w-lg">
        ...
        <div className=" bg-white text-gray-800 rounded-3xl p-6 shadow-lg">
          ...
          <div className=" mt-6 flex items-center gap-3">
            <div className=" w-12 h-12 rounded-full bg-blue-100 flex items-center justify-center">
              <Star
                className="text-blue-600"size={25}/>
            </div>
