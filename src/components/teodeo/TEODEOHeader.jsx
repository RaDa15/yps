...
// =====================================================
// TEO / DEO NOTIFICATIONS
// =====================================================

const notificationsData = [
  {
    id: 1,
    title: "Programme Review Required",
    message: "2 programmes require your review.",
    time: "10 minutes ago",
    type: "approval",
    unread: true,
  },
  ...
  },
  {
    ...
    message:
      "24 volunteer activities were recorded today.",
    time: "Today",
    type: "volunteer",
    unread: true,
  },
...
const TEODEOHeader = () => {
  ...
  const handleSettings = () => {
    ...
    navigate("/teodeo-dashboard/settings");
  };
    ...
    >
      ...
      <div className="min-w-0">
        ...
        <p
          ...
          "
        >
          Dzongkhag Youth Coordination Administration
        </p>
      </div>
              ...
              >
                <button
                  ...
                  onClick={() => {
                    ...
                    navigate(
                      "/teodeo-dashboard/notifications"
                    );
                  }}
                  className="
                    w-full
