...
const menu = [
...

  {
    ...
    path: "/pycd-dashboard/youth-analytics",
    icon: Users,
  },

  {
    name: "Youth Centre Performance",
    path: "/pycd-dashboard/centres",
    icon: Building2,
  },
...

  {
    ...
    path: "/pycd-dashboard/volunteers",
    icon: HeartHandshake,
  },

  {
    name: "Approval Monitoring",
    path: "/pycd-dashboard/approvals",
    icon: CheckSquare,
  },
...

  {
    ...
    path: "/pycd-dashboard/system-management",
    icon: UserCog,
  },
